/* PrismJS 1.28.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+aspnet+bash+basic+csharp+css-extras+fsharp+git+javadoclike+jsdoc+js-templates+markup-templating+php+phpdoc+php-extras+powerquery+powershell+cshtml+shell-session+sql+typescript+vbnet+visual-basic+xml-doc+xquery&plugins=line-numbers+show-language+inline-color+toolbar+copy-to-clipboard */
